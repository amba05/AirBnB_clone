...
```
$ git clone https://github.com/amba05/AirBnB_clone.git
```
...
- [AirBnB clone: Concept Page](https://alx-intranet.hbtn.io/concepts/74)
- [Helpful Youtube playlist](https://www.youtube.com/playlist?list=PLlLHfkTcnvmPOp6jv_89tRpJUMFrP-Wbi)
...
- Amba Emmanuel - @amba05
- Alade Toheeb - @Horlarmmy
